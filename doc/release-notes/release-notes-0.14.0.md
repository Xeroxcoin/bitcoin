...
now ZMQ can be used on Windows. Please see [this document](https://github.com/Xeroxcoin/xeroxcoin/blob/master/doc/zmq.md) for
...
Commands sent over the JSON-RPC interface and through the `xeroxcoin-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`xeroxcoin-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/xeroxcoin-cli -named help command="help"
    src/xeroxcoin-cli -named getblockhash height=0
    src/xeroxcoin-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/xeroxcoin-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   ...
   optimizations to memory management. See [Pull #8753](https://github.com/Xeroxcoin/xeroxcoin/pull/8753)
...
- #8722 `bb843ad` xeroxcoin-cli: More detailed error reporting (laanwj)
...
### Documentation
- #15440 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
...
- #8813 `fb24d7e` xeroxcoind: Daemonize using daemon(3) (laanwj)
...
- #9265 `31bcc66` xeroxcoin-cli: Make error message less confusing (laanwj)
