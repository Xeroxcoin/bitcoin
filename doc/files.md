...
* bitcoin.conf: contains configuration settings for xeroxcoind or xeroxcoin-qt
* xeroxcoind.pid: stores the process id of xeroxcoind while running
...
* debug.log: contains debug information and general logging generated by xeroxcoin or xeroxcoin-qt
