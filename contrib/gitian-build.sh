...
VERSION=
commit=false
url=https://github.com/Xeroxcoin/xeroxcoin
proc=2
mem=2000
lxc=true
osslTarUrl=http://downloads.sourceforge.net/project/osslsigncode/osslsigncode/osslsigncode-1.7.1.tar.gz
osslPatchUrl=https://xeroxcoin.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
-u|--url	Specify the URL of the repository. Default is https://github.com/Xeroxcoin/xeroxcoin
