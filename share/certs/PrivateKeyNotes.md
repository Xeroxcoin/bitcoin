...
allowing somebody to distribute a Bitcoin-Qt.app or xeroxcoin-qt-setup.exe with a valid
...
that the xeroxcoin-qt.exe file inside the installer had not been tampered with.
