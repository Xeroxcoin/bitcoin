...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xeroxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xeroxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xeroxcoin transaction") + "\n" +
              "  xeroxcoin-tx [options] -create [commands]   " + _("Create hex-encoded xeroxcoin transaction") + "\n" +
              "\n";
