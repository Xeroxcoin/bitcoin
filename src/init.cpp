 ...
 * between xeroxcoind, and xeroxcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("xeroxcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Xeroxcoin/xeroxcoin>";
    const std::string URL_WEBSITE = "<https://xeroxcoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("xeroxcoin-loadblk");
